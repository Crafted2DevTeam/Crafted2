...
public class TileEntityMannCoSteelCrate extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "Mann Co Steel Crate";
	}
	...
	{
		return new ContainerMannCoSteelCrate(playerInventory, this, playerIn);
	}
	
	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":steel_crate";
	}
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerMannCoEmaraldCrate)
                {
                    if (((ContainerMannCoSteelCrate)entityplayer.openContainer).getChestInventory() == this)
                    {
